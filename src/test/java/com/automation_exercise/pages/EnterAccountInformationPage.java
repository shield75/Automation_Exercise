...
import com.automation_exercise.utilities.JSONReader;
...
public class EnterAccountInformationPage extends TestBasic {
    ...
    public AccountCreatedPage fillAccountDetails() throws IOException, ParseException, InterruptedException {
