...
import com.automation_exercise.pages.HomePage;
import com.automation_exercise.pages.LoginSignupPage;
import com.automation_exercise.utilities.Util;
...
import com.automation_exercise.pages.*;
...
public class TestCase1 extends TestBasic{
    ...
    private void verifyThatAccountCreatedIsVisible() throws IOException, ParseException, InterruptedException {
